...
Q5:
Write a program that uses a switch case to assign a grade ('A','B','C','D') based on a scroe and log the grade to the console.
Q6:
Write a pgraom that uses the ternary operator to check if a number is even or odd and log the result to the consoe
